...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center mt-10 p-10  text-white">
                <aside>
                    ...
                    <p className="font-bold text-xl">
                        BPL-2023 Industries Ltd. <br />Providing reliable tech since 1992
                    </p>
                    <p>Copyright © 2023 - All right reserved by BCB</p>
                </aside>
                <nav>
